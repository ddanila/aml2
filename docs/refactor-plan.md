...
3. Remove dead UI code and tidy clearly safe internal helpers in the UI implementation.
4. Make `tests/dos/test_kvikdos_smoke.sh` configurable and able to skip cleanly when `kvikdos` is unavailable.
...
- `bash tests/dos/test_kvikdos_smoke.sh`
